const { diffBetweenDays, coordinates, weekForecast } = require('../src/client/js/formHandler')
...
test('Error: missing one date', () => {
    const date1 = new Date(2020, 5, 5);
    expect(() => diffBetweenDays(date1)).toThrow();
});
